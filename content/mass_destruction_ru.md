...
* Одно из требований для версии 1.0 выполнено: тип врагов - роботы. Роботы имеют текстуры и звуки, двигаются и стрелают ракетой. Ракета взрывается при попадании и наносит урон ближайшим объектам и игроку. Следующая фича из списка требований к версии 1.0, которую я планирую реализовать, это типы оружия - пулемёт.
...
_Гранаты_ кидаешь, и они взрываются. Надо сделать соответствующую анимацию. Гранаты наносят урон врагам и другим объектам (например, стенам) в радиусе действия.
