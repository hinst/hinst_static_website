...
* Двери теперь открываются когда игрок близко и закрываются когда игрок отходит от двери. Теперь не нужно нацеливаться на дверь и нажимать кнопку E. Так удобнее.

## 2015.09.25

* Ящик с здоровьем теперь работает.
* Ящик с патронами для автомата теперь работает.
* _План_: нужно будет сделать чтобы игрок замедлялся когда он находится близко к врагам, иначе можно пробегать сквозь толпы врагов.

## 2015.09.26

* Ящичек с ракетами теперь работает.
* Игрок теперь замедляется когда оказывается в клетке в которой есть враг.
* Враги, находящиеся на прилегающих клетках, активируются все если один из них активируется.
* Новый объект-декорация: серверный шкафчик.
...
_Двери_ делятся на запертые и нормальные. Запертые можно только разрушить. Нормальные двери можно открывать и закрывать. Нормальными дверями можно запираться от монстров. Двери открываются когда игрок близко и закрываются когда игрок отходит от двери.
